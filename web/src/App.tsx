...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/gltf', initials: 'gl', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/gltf</span> — a dependency-free glTF 2.0 / GLB toolkit for Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · standard-library-only glTF 2.0 implementation</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/gltf" footer={footer}>
