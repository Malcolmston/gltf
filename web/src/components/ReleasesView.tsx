...
// the GitHub Releases API for malcolmston/gltf.
const RELEASE_LIBS: RelLib[] = [
  { name: GLTF.name, icon: GLTF.icon, accent: GLTF.accent, repo: ghrepo(GLTF), url: GLTF.repo },
];
